...
const RenderBody = ({ home, projects, meta }) => {
  ...
  return (
    <>
      ...
      />
      <h1>Bulaava App Privacy Policy</h1>
      <div>
        <strong>Privacy Policy</strong>
        <p>
          AWE SPIRING DESIGNS PRIVATE LIMITED built the Bulaava app as a Free
          app. This SERVICE is provided by AWE SPIRING DESIGNS PRIVATE LIMITED
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Bulaava unless otherwise
        ...
        <p>
          ...
          including but not limited to Name, Email, Phone Number. The
        ...
        <p>This policy is effective as of 2022-04-12</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at support@bulaava.in.
        </p>
      </div>
    </>
  )
